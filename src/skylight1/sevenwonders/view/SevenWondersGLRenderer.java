...
public class SevenWondersGLRenderer implements Renderer {
	...
	private CollisionDetector obstacleCollisionDetector;
	
	private int score;

	private Carpet carpet;

	private List<OpenGLGeometry> decorationGeometries;
	
	private Map<Integer, Texture> textureResourceIdToTextureMap;
	...
	private OpenGLGeometryBuilder<GeometryBuilder.TexturableTriangle3D<GeometryBuilder.NormalizableTriangle3D<Object>>, GeometryBuilder.TexturableRectangle2D<Object>> openGLGeometryBuilder;
	...
	public void onSurfaceChanged(final GL10 aGl, final int aW, final int aH) {
		...
		obstacleCollisionDetector = new CollisionDetector();
		
		decorationGeometries = new ArrayList<OpenGLGeometry>();
		textureResourceIdToTextureMap = new HashMap<Integer, Texture>();
	...
	public void onDrawFrame(final GL10 aGl) {
		Log.i("7WRenderer", "player position: " + playerWorldPosition);
