...
public class Facebook {
    ...
    public void dialog(Context context, 
        ...
        if (action.equals(LOGIN)) {
    		...
    		//XXX Shouldn't be needed, but fixes a bug where Facebook shows 
    		//an error page with a random app's name.
    		//See http://bugs.developers.facebook.net/show_bug.cgi?id=13702 .
            parameters.putString("app_id", FacebookConfig.getAppId());
        }
        ...
        if (context.checkCallingOrSelfPermission(Manifest.permission.INTERNET)
        	...
        	DialogUtil.safeShow(new FbDialog(context, url, listener));
        }
    }
